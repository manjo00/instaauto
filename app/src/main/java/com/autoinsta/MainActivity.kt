...
import com.autoinsta.ui.presets.PresetsScreen
            ...
            NavHost(
                ...
                composable(
                    ...
                    ComposePostScreen(
                        ...
                        onOpenPresets = { navController.navigate(ROUTE_PRESETS) },
                    )
                }
                ...
                composable(ROUTE_PRESETS) {
                    PresetsScreen(onNavigateBack = { navController.popBackStack() })
                }
            }
        }
    }
